...
export default function Home() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-3.5rem)] overflow-hidden">
      ...
      <div className="mx-auto grid min-h-[calc(100vh-3.5rem)] max-w-7xl grid-cols-1 items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.p
            variants={item}
            className="mb-6 text-sm font-bold uppercase tracking-widest text-primary"
          >
          ...
          <motion.h1
            variants={item}
            className="mb-6 text-5xl font-extrabold tracking-tight text-text sm:text-6xl lg:text-7xl"
          >
          ...
          {info.bio && (
            <motion.p
              variants={item}
              className="mb-10 text-lg leading-relaxed text-text-muted sm:text-xl"
            >
              {info.bio}
            </motion.p>
          )}
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500/30 via-primary/30 to-purple-500/30 blur-2xl"></div>
            {info.profileImage ? (
              <motion.img
                ...
                className="relative h-64 w-64 rounded-full border-4 border-primary/30 object-cover shadow-2xl ring-8 ring-primary/10 sm:h-80 sm:w-80"
              />
            ) : (
              <motion.div
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.3 }}
                className="relative flex h-64 w-64 items-center justify-center rounded-full border-4 border-primary/30 bg-primary/10 text-6xl font-bold text-primary shadow-2xl ring-8 ring-primary/10 sm:h-80 sm:w-80"
                aria-hidden="true"
              >
                {initials}
              </motion.div>
